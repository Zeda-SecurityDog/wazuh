...
def run(args):
    ...
    try:
        integration = Integration(args, integration_config)
        integration.run()
    except Exception as e:
...
def configure(subparsers):
    ...
    parser.add_argument('-j', '--json', action='store_true', help=f'Allows the output and trace generated by an event to be printed in Json format.',
